...
// @access  Private
const profileAddress = asyncHandler(async (req, res) => {
  const user = await User.findById(req.params.id);
console.log(user.Address.phoneNumber);
  if (user) {
    res.json({
...
const updateUserProfile = asyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    user.Address.phoneNumber = req.body.phoneNumber || user.Address.phoneNumber;
